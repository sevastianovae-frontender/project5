...
import { Divider, Avatar, Row, Col, Tag } from 'antd';


export const PostOne = ({ _id, text, updated_at, author, title, created_at, tags }) => {
    ...
    return (
        <>
            <Col offset={4} span={9} style={{ marginBottom: "30px"}}>
                ...
                <Row> {text}</Row>
                <Divider/>
                <Tag color="processing" style={{ height: "24px", marginLeft: "5px" }}>{tags}</Tag>
            </Col>
